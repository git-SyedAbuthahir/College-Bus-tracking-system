...
class MyDemoPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    /// their money
    const String _payToName = 'Bus Fees';
    ...
    // Put it all together
    return Scaffold(
      appBar: AppBar(title: Text('Fee payment'),centerTitle: true, backgroundColor: Colors.yellow.shade800,foregroundColor: Colors.black,),
      body: CheckoutPage(
